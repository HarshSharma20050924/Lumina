              ...
              {colOrders.map((order) => (
                <div key={order.id} className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 group">
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-xs font-mono text-gray-500">#{order.id.split('-')[2]}</span>
                  ...
                  <div className="flex gap-2 pt-2 border-t border-gray-50">
                    ...
                    {col.status === 'shipped' && (
                      <button 
                         ...
                         className="flex-1 py-1.5 text-xs font-medium bg-green-50 text-green-600 rounded hover:bg-green-100"
                      >
                        Mark Delivered
                      </button>
                    )}
