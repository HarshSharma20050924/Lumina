...
export const Checkout = () => {
  const { checkoutStep, setCheckoutStep, navigateHome, cart, placeOrder, user, navigateToProfile } = useStore();
  ...
  const handleNext = async () => {
    if (checkoutStep === 2) {
      ...
      placeOrder(shippingAddress); // Place order using store action
      ...
      <div className="min-h-[80vh] flex items-center justify-center container mx-auto px-4 relative">
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <Button onClick={() => { setCheckoutStep(1); navigateHome(); }} size="lg">
              Continue Shopping
            </Button>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-8">
        <div className="mb-8">
           <Breadcrumbs items={[
             ...
             { label: 'Cart', onClick: () => {} }, // In a real app, this might open cart
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            ...
            >
              {checkoutStep === 1 && <AddressForm />}
              {checkoutStep === 2 && <PaymentMethods />}
            </motion.div>
